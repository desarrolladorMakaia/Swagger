package com.firstapi.myfirstapi.configuration;
...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .version("1.0.0")
                .contact(new Contact("Juan Sebastian Alvarez","https://www.linkedin.com/in/mi-usuario-en-linkedin","juan@gmail.com")
                )
                .build();
    }
}